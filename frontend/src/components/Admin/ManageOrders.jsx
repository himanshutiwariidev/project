...
import { Package, User, Calendar, CreditCard, CheckCircle, XCircle, Clock, Ban, AlertCircle, Loader } from "lucide-react";

const ManageOrders = () => {
  const [orders, setOrders] = useState([]);
  const [cancellationRequests, setCancellationRequests] = useState([]);
  const [activeTab, setActiveTab] = useState("all"); // 'all' or 'cancellations'
              ...
              return (
                <div
                  ...
                  className={`p-6 border rounded-2xl shadow-md hover:shadow-lg transition relative ${
                    order.cancelled ? 'border-orange-200 bg-orange-50' : 'border-gray-200 bg-white'
